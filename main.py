...
p_b = pygame.image.load("piece_black.png")
p_w = pygame.image.load("piece_white.png")
p_b_re = pygame.image.load("piece_black_re.png")
p_w_re = pygame.image.load("piece_white_re.png")

player2_img = [p_w_re, p_b_re]
player1_img = [p_w, p_b]
...
async def main():    #これが必須の奴
  ...
  #駒の初期位置
  player1_piece = [[0,4], [1,4], [2,4], [3,4], [4,4]]
  player2_piece = [[0,0], [1,0], [2,0], [3,0], [4,0]]
  #初期の手持ちのパネル
